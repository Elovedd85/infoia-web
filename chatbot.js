...
(function () {
  ...
  function handleUserMessage(text) {
    ...
    var WA_URL = 'https://wa.me/34600000000?text=Hola%2C%20me%20interesa%20una%20consulta%20gratuita%20con%20InfoIA.';
  ...
  function init() {
    ...
    /* Bounce & greeting after delay */
    setTimeout(function () {
      var btn = $('chat-toggle');
      btn.classList.add('chat-bounce');
      btn.addEventListener('animationend', function () { btn.classList.remove('chat-bounce'); }, { once: true });
    }, 2800);
